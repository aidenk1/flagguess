...
<body>
  ...
  <form>
    ...
    <p>
      ...
      <button type="button" onclick="window.location.href='/guesstheflag/signup'" class="button-spacing">Sign Up</button>
    </p>
  </form>
    ...
    async function login_api(uid, password) { 
      ...
      try {
        ...
        if (response.ok) {
          ...
          window.location.href = "/guesstheflag/game"; // Redirecting to homepage
        } else {
